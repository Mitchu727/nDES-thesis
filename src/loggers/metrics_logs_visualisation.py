...
if __name__ == "__main__":
    ...
    ax = generator_log_df.plot(y='Średnie wskazanie', legend=None)
    ...
    ax = generator_log_df.plot(y='Minimalne wskazanie', legend=None)
    ax.xaxis.set_label_text("")
    plt.grid(True)
    ...
    ax = generator_log_df.plot(y='Maksymalne wskazanie', legend=None)
    ax.xaxis.set_label_text("")
    plt.grid(True)
